...
const REQUEST_TOTAL_BUDGET_TEXT_MS = parsePositiveIntEnv("HUGE_AI_SEARCH_TOTAL_BUDGET_TEXT_MS", 30000);
...
const SEARCH_EXECUTION_TIMEOUT_TEXT_MS = parsePositiveIntEnv("HUGE_AI_SEARCH_EXECUTION_TIMEOUT_TEXT_MS", 28000);
